...
const inputStyles = tv({
  base: [
    // base
    'relative block w-full appearance-none rounded-md border px-2.5 py-1.5 shadow-sm focus:outline-none outline-none sm:text-sm transition',
    // border color
    'dark:border-emerald-600/20',
    // focus
    'focus:ring-[0.5px] focus:ring-emerald-300/40 focus:border-emerald-300',
    // text color
    'text-gray-900 dark:text-gray-50',
    // placeholder color
    'placeholder-gray-400 dark:placeholder-gray-500',
    // background color
    'bg-white dark:bg-gray-950/20',
    // disabled
